(function(sttc) {
    ...
    var na = ja
      ...
      , ra = ea && typeof v(Object, "assign") == "function" ? v(Object, "assign") : function(a, b) {
...
*/
    ...
    ;var Ca, Da = va("CLOSURE_FLAGS"), Ea = Da && Da[610401301];
    Ca = Ea != null ? Ea : !1;
    ...
    ;function Ia() {
        return Ca ? !!Fa && Fa.brands.length > 0 : !1
    }
    function Ja() {
        return Ia() ? !1 : E("Opera")
    }
    ...
    function hc(a) {
        ...
        b = a.indexOf(".");
        b !== -1 && (a = a.substring(0, b));
        return pb() ? Cb(Rb(64, BigInt(a))) : Cb(mc(a))
    }
    function ic(a) {
    ...
    function N(a, b, c, d) {
        ...
        if (d !== void 0) {
            var h;
            f = ((h = b) != null ? h : b = a[F] | 0) >> 13 & 1023 || 536870912;
            c >= f ? d != null && (e = {},
            a[f + -1] = (e[c] = d,
            e)) : a[e] = d
        }
    ...
    function Jc(a, b, c, d, e) {
        ...
        k !== h && (G(a, k),
        2 & k && Object.freeze(a));
        return a = Mc(a, k, f, g, b, d, m, e)
    }
    function Mc(a, b, c, d, e, f, g, h) {
        var k = b;
        f === 1 || (f !== 4 ? 0 : 2 & b || !(16 & b) && 32 & d) ? Nc(b) || (b |= !a.length || g && !(4096 & b) || 32 & d && !(4096 & b || 16 & b) ? 2 : 256,
        b !== k && G(a, b),
        Object.freeze(a)) : (f === 2 && Nc(b) && (a = Pb(a),
        k = 0,
        b = Lc(b, d),
        d = N(c, d, e, a)),
        Nc(b) || (h || (b |= 16),
        b !== k && G(a, b)));
        2 & b || !(4096 & b || 16 & b) || Ec(c, d);
        return a
    }
    function Kc(a, b) {
        2 & b && (a |= 2);
    ...
    var Xc = function(a, b, c) {
        a = a.i;
        (c = Hc(a, a[F] | 0, b, c)) || (c = b[eb]) || (c = new b,
        mb(c.i, 34),
        c = b[eb] = c);
        return c
    }
    ...
    function Yc(a, b, c, d, e, f, g, h) {
        ...
        if (h = !(4 & n)) {
            var l = a
              ...
              , r = !!(2 & n);
            r && (p |= 2);
            for (var t = !r, z = !0, A = 0, pa = 0; A < l.length; A++) {
                var cb = qc(l[A], d, !1, p);
                if (cb instanceof d) {
                    if (!r) {
                        var db = H(cb);
        ...
        return a = Mc(a, n, b, c, e, f, h, g)
    }
    var R = function(a, b, c, d) {
        var e = a.i;
        return Yc(a, e, e[F] | 0, b, c, d, !1, !0)
    };
    function Zc(a) {
        a == null && (a = void 0);
        return a
    ...
    var $c = function(a, b, c) {
      ...
      , bd = function(a, b, c) {
        ...
        if (c == null)
            return N(d, e, b),
            a;
        for (var f = c === kb ? 7 : c[F] | 0, g = f, h = Nc(f), k = h || Object.isFrozen(c), m = !0, n = !0, l = 0; l < c.length; l++) {
            var p = c[l];
            h || (p = H(p),
            m && (m = !p),
            n && (n = p))
    ...
    var dd = function(a, b) {
      ...
      , kd = function(a, b, c) {
        return Pc(a, b, c == null ? c : ac(c), 0)
    }
      , ld = function(a, b, c) {
        return Pc(a, b, kc(c), "0")
    }
      , md = function(a, b, c) {
        return Pc(a, b, oc(c), "")
    }
      ...
      , od = function(a, b, c) {
        return Pc(a, b, c == null ? c : Zb(c), 0)
    }
      , pd = function(a, b, c, d) {
        return Tc(a, b, c, d == null ? d : Zb(d))
    };
    ...
    function yd() {
        try {
            return wd != null || (wd = new Uint32Array(64)),
            xd >= 64 && (crypto.getRandomValues(wd),
            xd = 0),
            wd[xd++]
        } catch (a) {
    ...
    ;function zd(a, b) {
        if (!yb(a.goog_pvsid))
            try {
                var c = yd() + (yd() & 2097151) * 4294967296;
    ...
    var Bd = function() {
        return Ca && Fa ? !Fa.mobile && (E("iPad") || E("Android") || E("Silk")) : E("iPad") || E("Android") && !E("Mobile") || E("Silk")
    };
    function Cd(a) {
        var b = [], c = 0, d;
        for (d in a)
...
*/
    ...
    ;function Od(a, b) {
        ...
        if (b == null ? 0 : b.async)
            a += " async";
        (b == null ? void 0 : b.attributionSrc) !== void 0 && (a += ' attributionsrc="' + Pd(b.attributionSrc) + '"');
        if (b == null ? 0 : b.Va)
            a += ' custom-element="' + Pd(b.Va) + '"';
        if (b == null ? 0 : b.defer)
            a += " defer";
        if (b == null ? 0 : b.id)
            a += ' id="' + Pd(b.id) + '"';
    ...
    function Rd(a, b) {
        ...
        var c = a.split(/[?#]/)
          , d = /[?]/.test(a) ? "?" + c[1] : "";
        return Sd(c[0], d, /[#]/.test(a) ? "#" + (d ? c[2] : c[1]) : "", b)
    }
    function Sd(a, b, c, d) {
        function e(g, h) {
    ...
    ;var Td = function(a) {
      ...
      , Xd = Ad(function() {
        return (Ca && Fa ? Fa.mobile : !Bd() && (E("iPod") || E("iPhone") || E("Android") || E("IEMobile"))) ? 2 : Bd() ? 1 : 0
    });
    function Yd(a, b) {
        if (a.length && b.head) {
            a = y(a);
    ...
    var te = function(a) {
        try {
            ...
            b.specialFeatureOptins = se(qe(c, 12, ke), ke);
            b.purpose = {
                consents: se(qe(c, 24, je), je),
                legitimateInterests: se(qe(c, 24, je), je)
            };
            b.purposeOneTreatment = !!V(c, 1);
            b.publisherCC = String.fromCharCode(ie + V(c, 6)) + String.fromCharCode(ie + V(c, 6));
            b.vendor = {
                consents: se(re(c), null),
                legitimateInterests: se(re(c), null)
            };
            return b
        } catch (d) {
            return null
    ...
    function ye(a, b) {
        ...
        c.fetch(a, b)) : we(c, a, b === void 0 ? !1 : b, d === void 0 ? !1 : d)
    }
    ;function ze(a, b) {
        try {
            var c = function(d) {
    ...
    x(Ce, U);
    var Ee = function(a, b) {
        return Tc(a, 3, De, b == null ? b : Wb(b))
    }
      , De = [1, 2, 3];
    var Fe = function(a) {
        this.i = L(a)
    ...
    x(pf, U);
    pf.prototype.ab = function() {
        return ed(this, 2)
    }
    ;
    pf.prototype.Za = function(a) {
        var b = Jc(this, 3, pc, 3, !0);
        sb(b, a);
        return b[a]
    }
    ;
    ...
    var wf = function(a) {
        this.g = a;
        this.Ra = new vf(this.g)
    }
      , vf = function(a) {
        this.g = a;
        this.Ha = new xf(this.g)
    }
      , xf = function(a) {
        this.g = a;
        this.outstream = new yf;
        this.request = new zf;
        this.threadYield = new Af;
        this.cb = new Bf(this.g);
        this.gb = new Cf(this.g);
        this.nb = new Df(this.g)
    }
      , Bf = function(a) {
        this.g = a
    };
    Bf.prototype.W = function(a) {
        this.g.C(Ke(Le(Le(Je("JwITQ"), Ee(new Ce, a.la)), Ee(new Ce, a.na)), He(new Fe, Math.round(a.Z))))
    }
    ;
    var Cf = function(a) {
        this.g = a
    };
    Cf.prototype.W = function(a) {
        this.g.C(Ke(Le(Le(Je("Pn3Upd"), Ee(new Ce, a.la)), Ee(new Ce, a.na)), He(new Fe, Math.round(a.Z))))
    }
    ;
    var Df = function(a) {
        this.g = a
    ...
    Df.prototype.W = function(a) {
        var b = this.g
          ...
          , d = Je("rkgGzc");
        var e = new Ce;
        e = Tc(e, 2, De, kc(a.source));
        d = Le(d, e);
        e = new Ce;
        e = Tc(e, 2, De, kc(a.Ua));
        c.call(b, Ke(Le(d, e), He(new Fe, Math.round(a.Z))))
    }
    ;
    var yf = function() {}
      , zf = function() {}
    ...
    ;var Hf = function(a, b, c, d, e, f, g, h) {
        Ff.call(this, a, b);
        this.T = c;
        this.S = d;
        this.U = e;
    ...
    Hf.prototype.l = function() {
        var a = sa.apply(0, arguments)
          , b = this;
        try {
            this.R && ze(this.g.concat(a), this.o).length >= 65536 && If(this),
            this.J && !this.L && (this.L = !0,
            this.J.g(function() {
                If(b)
            })),
            this.g.push.apply(this.g, B(a)),
            this.g.length >= this.P && If(this),
    ...
    var Jf = function(a, b, c, d, e, f) {
        Hf.call(this, a, b, "https://pagead2.googlesyndication.com/pagead/ping", Gf, c === void 0 ? 1E3 : c, d === void 0 ? 100 : d, (e === void 0 ? !1 : e) && !!u.globalThis.fetch, f)
    };
    x(Jf, Hf);
    var Kf = function(a) {
        this.g = a;
    ...
    var Mf = new Lf(695925491,20)
      , Nf = new Kf(45624259)
      , Of = new Lf(635239304,100)
      , Pf = new Kf(662101539)
      , Qf = new Lf(682056200,100)
      , Rf = new Lf(24)
      , Sf = new function(a, b) {
        b = b === void 0 ? [] : b;
        this.g = a;
    ...
    ;Cd(ae).map(function(a) {
        return Number(a)
    });
    Cd(be).map(function(a) {
        return Number(a)
    });
    var ag = function(a) {
        this.g = a
    ...
    ;var pg = function(a) {
        ...
        c = og(b.Ga);
        b = b.Da;
        if (b != null && pc(M(b, 2)) != null && S(b, 2).length !== 0) {
            var d = Ic(b, le, 1) ? Q(b, le, 1) : me();
            b = {
                uspString: S(b, 2),
                ia: ne(d)
            }
            ...
            b = null;
        this.l = b && c ? c.ia > b.ia ? c.uspString : b.uspString : b ? b.uspString : c ? c.uspString : null;
        this.tcString = (c = Zf(a.document)) && pc(M(c, 1)) != null ? S(c, 1) : null;
        this.j = (a = Zf(a.document)) && pc(M(a, 2)) != null ? S(a, 2) : null
    }
      , sg = function(a) {
        a !== a.top || a.__uspapi || a.frames.__uspapiLocator || (a = new pg(a),
        qg(a),
        rg(a))
    }
      , qg = function(a) {
      ...
      , og = function(a) {
        if (a == null || pc(M(a, 1)) == null || S(a, 1).length === 0 || R(a, gg, 2, P()).length === 0)
            return null;
        var b = S(a, 1);
        try {
            var c = ge(b.split("~")[0]);
        ...
        a = R(a, gg, 2, P()).reduce(function(e, f) {
            var g = tg(e);
            g = gd(g, 1);
            g = mg(g);
            var h = tg(f);
        ...
        c = Jc(c, 3, bc, P()).indexOf(ed(a, 1));
        return c === -1 || c >= d.length ? null : {
            uspString: jg(d[c], ed(a, 1)),
            ia: ne(tg(a))
        }
    }
      , tg = function(a) {
        return Ic(a, le, 2) ? Q(a, le, 2) : me()
    }
      , rg = function(a) {
    ...
    var ug = qa(["https://pagead2.googlesyndication.com/pagead/managed/dict/", "/gpt"])
      , vg = qa(["https://securepubads.g.doubleclick.net/pagead/managed/dict/", "/gpt"]);
    function wg(a, b, c) {
        try {
            var d = a.createElement("link"), e, f;
            if (((e = d.relList) == null ? 0 : (f = e.supports) == null ? 0 : f.call(e, "compression-dictionary")) && Ma()) {
                if (b instanceof Fd)
                    d.href = Hd(b).toString(),
    ...
    var Ig = function(a, b, c) {
        var d = d === void 0 ? new Jf(6,"unknown",b) : d;
        this.C = a;
        this.o = c;
        this.j = d;
        this.g = [];
      ...
      , Kg = function(a, b, c, d, e, f) {
        if (a.l) {
            var g = Pe(Oe(new Ne, b), c);
            b = Xe(Ue(Te(We(Ve(new Se, d), e), g), a.g.slice()), f);
            b = kf(b);
            a.j.ea(Jg(a, b));
    ...
    function Sg(a, b, c, d) {
        ...
        W(Tg).l[e] = (g = (f = W(Tg).l[e]) == null ? void 0 : f.add(b)) != null ? g : (new u.Set).add(b);
        e = Rg();
        if (e[b] != null)
            return e[b];
        b = Ug(d)[b];
    ...
    function Vg(a) {
        var b = W(Ng).A;
        if (b && Uc(a, Hg) !== 8) {
            var c = Oa(R(a, Eg, 5, P()), function(f) {
                f = Bg(Q(f, cf, 1), b);
    ...
    function Ug(a) {
        return W(Tg).j[a] || (W(Tg).j[a] = {})
    }
    function ah(a, b) {
        var c = Ug(b);
        Wd(a, function(d, e) {
            if (c[e]) {
                d = Gg(JSON.stringify(d));
                var f = Vc(d, Hg, 8);
                if ($b(M(d, f)) != null) {
    ...
    function bh(a, b, c, d, e) {
        ...
        for (var h = b.next(); !h.done; h = b.next()) {
            h = h.value;
            for (var k = Ug(h), m = y(a), n = m.next(); !n.done; n = m.next()) {
                n = n.value;
                var l = Uc(n, Hg)
                  , p = Pg(n, l);
                if (p) {
                    var r = void 0
                      , t = void 0
                      , z = void 0;
                    var A = (r = (z = W(Tg).g.get(h)) == null ? void 0 : (t = z.get(p)) == null ? void 0 : t.slice(0)) != null ? r : [];
                    a: {
                        r = p;
                        t = l;
                        z = new Ye;
                    ...
                    if (r = A)
                        t = void 0,
                        r = !((t = W(Tg).l[h]) == null || !t.has(p));
                    r && f.push(A);
                    if (l === 8 && k[p])
                        A = Gg(JSON.stringify(k[p])),
                        l = Wc(n, Cg, 4),
                        A = Dg(Xc(A, Cg, 4)),
                        cd(l, A);
                    else {
    ...
    function ch(a, b) {
        ...
        for (var c = a.next(); !c.done; c = a.next()) {
            c = c.value;
            var d = Gg(JSON.stringify(c))
              , e = Uc(d, Hg);
            (d = Pg(d, e)) && (b[d] || (b[d] = c))
        }
    }
    function dh() {
        return v(Object, "keys").call(Object, W(Tg).j).map(function(a) {
            return Number(a)
        })
    }
    function eh(a) {
        (q = W(Tg).o,
        v(q, "includes")).call(q, a) || ah(Ug(4), a)
    }
    ;function X(a, b, c) {
    ...
    function gh(a) {
        ...
        X(14, function(b) {
            for (var c = W(Ng), d = y([3, 4, 5]), e = d.next(); !e.done; e = d.next())
                e = e.value,
            ...
            f = e.next(); !f.done; f = e.next())
                ...
                vh(f).length !== 0) {
                    ...
                    if (T(f, 4) && !T(f, 13) && !T(f, 14)) {
                        ...
                        h = fd(f, 1) * vh(f).length;
                        c.set(T(f, 4), g + h)
                    }
                    h = [];
                    for (var k = 0; k < vh(f).length; k++) {
                        var m = {
                            Qa: g,
                            La: fd(f, 1),
                            Ma: vh(f).length,
                    ...
                    Bh(a[2], T(f, 10), h) || Bh(a[1], T(f, 4), h) || Bh(a[0], vh(f)[0].getId(), h)
                }
        return a
    }
    function Bh(a, b, c) {
    ...
    ;var Ih = [12, 13, 20]
      ...
      , Mh = function(a, b, c, d) {
        ...
        if (f = b !== 9)
            ...
            f = !1);
        if (f)
            return Kg(a.u, b, c, e, [], 4),
            e;
        f = v(Ih, "includes").call(Ih, b);
        for (var g = [], h = [], k = y([0, 1, 2]), m = k.next(); !m.done; m = k.next()) {
            m = m.value;
            for (var n = y(v(a.M[m], "entries").call(a.M[m])), l = n.next(); !l.done; l = n.next()) {
                var p = y(l.value);
                l = p.next().value;
                p = p.next().value;
                var r = l
                ...
                p = t.filter(function(db) {
                    return db.ba === b && a.j[db.F.getId()] && Kh(a, db)
                });
                if (p.length)
                    for (l = y(p),
                    ...
                    var z = void 0
                      , A = void 0;
                    p = (A = (z = p) == null ? void 0 : z(String(r))) != null ? A : m === 2 && T(t[0].fa, 11) === 1 ? void 0 : d[0](String(r));
                    if (p !== void 0) {
                        r = y(t);
                        for (t = r.next(); !t.done; t = r.next())
                            ...
                            t.ba === b) {
                                ...
                                var cb = pa.Ma;
                                pa = pa.jb;
                                z < 0 || z >= A * cb || z % cb !== pa || !Kh(a, t) || (z = T(t.fa, 13),
                                z !== 0 && z !== void 0 && (A = a.l[String(z)],
                                A !== void 0 && A !== t.F.getId() ? Lg(a.u, a.l[String(z)], t.F.getId(), z) : a.l[String(z)] = t.F.getId()),
                                h.push(t.F))
                            }
                        Uc(l, Re) !== 0 && (kd(l, 3, p),
                        g.push(l))
      ...
      , Kh = function(a, b) {
        var c = W(Ng).A
          , d = Bg(Q(b.fa, cf, 3), c);
        if (!d.success)
            return Mg(a.u, Q(b.fa, cf, 3), b.ba, b.F.getId(), d),
            !1;
        if (!d.value)
            return !1;
        c = Bg(Q(b.F, cf, 3), c);
        return c.success ? c.value ? !0 : !1 : (Mg(a.u, Q(b.F, cf, 3), b.ba, b.F.getId(), c),
        !1)
    }
      , Nh = function(a, b) {
        b = b.map(function(c) {
            ...
            return !v(Ih, "includes").call(Ih, T(c, 1))
        });
        a.M = Ah(a.M, b)
    }
      , Oh = function(a, b) {
    ...
    function Qh(a) {
        return W(Ph).j(a.g, a.defaultValue)
    }
    ;var Rh = function() {
        this.g = function() {}
    }
    ...
    function $h(a) {
        ...
        var c = a.A;
        var d = a.config;
        var e = a.Ta === void 0 ? sh() : a.Ta;
        var f = a.Ca === void 0 ? 0 : a.Ca;
        var g = a.u === void 0 ? new Ig((Xh = lg((Uh = Q(b, xh, 5)) == null ? void 0 : gd(Uh, 2))) != null ? Xh : 0,(Yh = lg((Vh = Q(b, xh, 5)) == null ? void 0 : gd(Vh, 4))) != null ? Yh : 0,(Zh = (Wh = Q(b, xh, 5)) == null ? void 0 : dd(Wh, 3)) != null ? Zh : !1) : a.u;
        a = a.M === void 0 ? zh(R(b, wh, 2, P(tb))) : a.M;
        e.hasOwnProperty("init-done") ? (Y(12, e, function() {})(R(b, wh, 2, P()).map(function(h) {
            return K(h)
        })),
        Y(13, e, function() {})(R(b, Fg, 1, P()).map(function(h) {
            return K(h)
        }), f),
        c && Y(14, e, function() {})(c),
        ai(f, e)) : (Oh(new Jh(a,f,g,d), e),
        fh(e),
        gh(e),
        hh(e),
        ai(f, e),
        bh(R(b, Fg, 1, P(tb)), [f], g, void 0, !0),
        Og = Og || !(!d || !d.ma),
        Th(rh),
        c && Th(c))
    }
    function ai(a, b) {
        var c = b = b === void 0 ? sh() : b;
        jh(W(ih), c, a);
        bi(b, a);
        a = b;
        Sh(W(Rh), a);
    ...
    ;var ci = qa(["https://pagead2.googlesyndication.com/pagead/js/err_rep.js"])
      , di = function() {
        var a = a === void 0 ? "jserror" : a;
        var b = b === void 0 ? .01 : b;
        var c = c === void 0 ? Qd(ci) : c;
        this.g = a;
        this.l = b;
        this.j = c
    };
    ...
    function mi(a, b, c) {
        ...
        return function() {
            ...
            try {
                ...
                e.google_measure_js_timing && h && ki(v(Object, "assign").call(Object, {}, {
                    label: a.toString(),
                    value: h,
                    duration: (ji() || 0) - h,
                    type: k
    ...
    function qi(a) {
        a = a.id;
        return a != null && (pi().has(a) || v(a, "startsWith").call(a, "google_ads_iframe_") || v(a, "startsWith").call(a, "aswift"))
    }
    function ri(a, b, c) {
        if (!a.sources)
            return !1;
    ...
    var xi = function() {
        ...
        this.l = this.j = this.U = this.S = this.L = 0;
        this.ya = this.va = Number.NEGATIVE_INFINITY;
        this.g = [];
        this.P = {};
        this.sa = 0;
        this.T = Infinity;
        this.qa = this.ta = this.ua = this.wa = this.Ba = this.C = this.Aa = this.ha = this.o = 0;
        this.ra = !1;
        this.ga = this.R = this.J = 0;
        this.u = null;
        this.xa = !1;
        this.pa = function() {}
        ;
        this.za = (a = document.querySelector("[data-google-query-id]")) ? a.getAttribute("data-google-query-id") : null
    }, yi, zi, Ci = function() {
        var a = new xi;
        if (W(Ph).g(Pf.g, Pf.defaultValue)) {
            var b = window;
        ...
        a.u || (a.u = new PerformanceObserver(ni(640, function(b) {
            Di(a, b)
        })));
        return a.u
    }, Bi = function(a) {
        var b = ni(641, function() {
            var d = document;
            if (d.prerendering)
                d = 3;
            else {
        ...
        if (!a.xa) {
            ...
            window.LayoutShift && (b += oi("cls", a.L),
            b += oi("mls", a.S),
            b += Z("nls", a.U),
            window.LayoutShiftAttribution && (b += oi("cas", a.C),
            b += Z("nas", a.wa),
            b += oi("was", a.Ba)),
            b += oi("wls", a.ha),
            b += oi("tls", a.Aa));
            window.LargestContentfulPaint && (b += Z("lcp", a.ua),
            b += Z("lcps", a.ta));
            window.PerformanceEventTiming && a.ra && (b += Z("fid", a.qa));
            window.PerformanceLongTaskTiming && (b += Z("cbt", a.J),
            b += Z("mbt", a.R),
            b += Z("nlt", a.ga));
            ...
            b += "&top=" + (D === D.top ? 1 : 0);
            b += a.za ? "&qqid=" + encodeURIComponent(a.za) : Z("pvsid", $d(D));
            window.googletag && (b += "&gpt=1");
            c = Math.min(a.g.length - 1, Math.floor((a.u ? a.sa : performance.interactionCount || 0) / 50));
            c >= 0 && (c = a.g[c].latency,
            c >= 0 && (b += Z("inp", c)));
            window.fetch(b, {
                keepalive: !0,
        ...
        if (!b.hadRecentInput) {
            ...
            a.j > a.ha && (a.ha = a.j,
            a.Ba = a.l,
            a.Aa = b.startTime + b.duration)
        }
    }, Di = function(a, b) {
        var c = yi !== window.scrollX || zi !== window.scrollY ? [] : Gi
          , d = Hi();
        b = y(b.getEntries());
        ...
        b.interactionId && (a.T = Math.min(a.T, b.interactionId),
        a.o = Math.max(a.o, b.interactionId),
        a.sa = a.o ? (a.o - a.T) / 7 + 1 : 0)
    }, Hi = function() {
        var a = v(Array, "from").call(Array, document.getElementsByTagName("iframe")).filter(qi)
          , b = [].concat(B(pi())).map(function(c) {
        ...
        yi = window.scrollX;
        zi = window.scrollY;
        return Gi = [].concat(B(a), B(b)).map(function(c) {
    ...
    x(Ki, U);
    Ki.prototype.getVersion = function() {
        return S(this, 2)
    }
    ;
    var Li = function(a) {
    ...
    var Vi = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    function Wi(a) {
        var b;
    ...
    function Yi(a) {
        ...
        a = a.navigator.userAgentData.getHighEntropyValues(Vi).then(function(c) {
    ...
    function Zi(a) {
        var b;
        return Si(Ri(Pi(Mi(Ti(Oi(Ui(Qi(Ni(new Li, a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""), ((b = a.fullVersionList) == null ? void 0 : b.map(function(c) {
            var d = new Ki;
            d = O(d, 1, oc(c.brand));
            return O(d, 2, oc(c.version))
        })) || []), a.wow64 || !1)
    }
    function $i(a) {
        var b, c;
        return (c = (b = Yi(a)) == null ? void 0 : b.then(function(d) {
            return Zi(d)
        })) != null ? c : null
    }
    ;var aj = function(a) {
    ...
    ;var lj = /^(?:https?:)?\/\/(?:www\.googletagservices\.com|securepubads\.g\.doubleclick\.net|(pagead2\.googlesyndication\.com))(\/tag\/js\/gpt(?:_[a-z]+)*\.js)/;
    function mj(a) {
        var b = a.Ja;
        var c = a.hb;
        var d = a.Pa;
        ...
        a[59] = function() {
            ...
            var t;
            r = (t = (p = Dh(r.location.href.match(Ch)[3] || null)) == null ? void 0 : p.split(".")) != null ? t : [];
            r.length < 2 ? p = null : (p = r[r.length - 1],
            p = p === "uk" || p === "br" || p === "nz" ? r.length < 3 ? null : Gh(r.splice(r.length - 3).join(".")) : Gh(r.splice(r.length - 2).join(".")));
            return n.call(m, l(p))
        }
        ,
        a[74] = function() {
            return v(sa.apply(0, arguments), "includes").call(sa.apply(0, arguments), String(Gh(window.location.href)))
        }
        ,
        a[61] = function() {
            return e
    ...
    ;function nj(a, b) {
        if (W(Ph).g(Nf.g, Nf.defaultValue)) {
            var c = function(d) {
    ...
    ;function oj(a) {
        return !(a == null || !a.src) && Dh(a.src.match(Ch)[3] || null) === "pagead2.googlesyndication.com"
    }
    ;var pj = qa(["https://pagead2.googlesyndication.com/pagead/managed/js/gpt/", "/pubads_impl.js"])
      , qj = qa(["https://securepubads.g.doubleclick.net/pagead/managed/js/gpt/", "/pubads_impl.js"]);
    function rj(a) {
        a = oj(a) ? Qd(pj, "m202507070101") : Qd(qj, "m202507070101");
        var b = Qh(Rf);
        return b ? Rd(a, new u.Map([["cb", b]])) : a
    }
    ;function sj(a, b) {
        var c = jj(246);
        c = vc(c);
        c = rd(yh, c);
        if (!R(c, Fg, 1, P()).length && R(a, Fg, 1, P()).length) {
            var d = R(a, Fg, 1, P());
            bd(c, 1, d)
        }
        !R(c, wh, 2, P()).length && R(a, wh, 2, P()).length && (d = R(a, wh, 2, P()),
        bd(c, 2, d));
        !Ic(c, xh, 5) && Ic(a, xh, 5) && (a = Q(a, xh, 5),
        $c(c, 5, a));
        kj(246, K(c));
        $h({
            Ya: c,
    ...
    x(tj, ej);
    var uj = qa(["https://pagead2.googlesyndication.com/pagead/ppub_config"])
      , vj = qa(["https://securepubads.g.doubleclick.net/pagead/ppub_config"]);
    function wj(a, b, c, d, e) {
        a = a.location.host;
        var f = Fh(b.src, "domain");
        b = Fh(b.src, "network-code");
        if (a || f || b) {
            var g = new u.Map;
            a && g.set("ippd", a);
            f && g.set("pppd", f);
        ...
        a ? (c = c ? Qd(uj) : Qd(vj),
        c = Rd(c, a),
        xj(c, d, e)) : e(new u.globalThis.Error("no provided or inferred data"))
    }
    function xj(a, b, c) {
    ...
    ;var yj = function(a, b, c) {
      ...
      , Cj = function(a, b, c, d, e) {
        var f = e == null ? void 0 : ud(Xc(e, td, 1));
        (f == null ? 0 : f.length) && v(b.location.hostname, "includes").call(b.location.hostname, f) ? (zj(a),
        Aj(a, {
            mb: e
        })) : (q = ["http:", "https:"],
        v(q, "includes")).call(q, b.location.protocol) ? c ? (zj(a),
        wj(Ud(b), c, d, function(g) {
            return void Aj(a, {
                ob: g
            })
        }, function(g) {
    ...
    ;function Ij() {
        ...
        a = Fj(a, e);
        vb(!W(ij).g);
        v(Object, "assign").call(Object, hj, b._vars_);
        b._vars_ = hj;
        a && (dd(a, 3) && kj(36, !0),
        S(a, 6) && kj(150, S(a, 6)),
        ii(Xc(a, gi, 13)) && kj(263, !0));
        var f = Xc(a, yh, 1)
          , g = {
            fb: hi(Xc(a, gi, 13)),
            hb: ed(a, 2),
        ...
        Hj("_loaded_", !0);
        Hj("cmd", []);
        var n, l = (n = Kj(m)) != null ? n : Lj(m);
        Mj(f, k, v(Object, "assign").call(Object, {}, {
            Ja: l
        }, g));
        try {
            Ci()
        ...
        if (fi(c.V, g)) {
            ...
            p.gb.W({
                Z: g,
                la: (l == null ? void 0 : l.crossOrigin) === "anonymous",
                na: oj(l)
            });
            p.cb.W({
                Z: g,
                la: f,
                na: Dh(n.toString().match(Ch)[3] || null) === "pagead2.googlesyndication.com"
            })
        }
        var r = !1;
        dj({
        ...
        Cj(new yj(c,d,e), k, l, oj(l), h);
        nj(k, function() {
            r = !0
        });
        S(a, 14) && wg(k.document, xg(S(a, 14), oj(l)), e)
    }
    function Jj() {
        var a = $d(window)
          , b = new ei
          , c = new Jf(11,"m202507070101",1E3);
        return {
            oa: c,
            K: b,
            da: new tj(c,b,{
    ...
    function Mj(a, b, c) {
        ...
        fj(12);
        fj(5);
        (a = $i(b)) && a.then(function(d) {
            return void kj(251, JSON.stringify(K(d)))
        });
        Yd(W(Ph).l(Sf.g, Sf.defaultValue), b.document)
    }
    function Nj(a) {
        var b = Kj(a);
